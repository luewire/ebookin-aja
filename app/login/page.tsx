...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Wait for session to be saved to cookies before redirecting
      if (data.session) {
      ...
      if (error.message?.includes('Email not confirmed')) {
        setError('Email not confirmed. Please check your email or disable email confirmation in Supabase Dashboard.');
      } else {
