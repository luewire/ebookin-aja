    ...
    try {
      ...
      const { error } = await supabase.auth.updateUser({
        data: {
          ...
          bio: bio || '',
          reading_goal: parseInt(readingGoal) || 25,
          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-2 mb-4">
              <Link href="/" className="group">
                <Image src="/logo.svg" alt="Ebookin Logo" width={64} height={64} className="h-16 w-16 invert dark:invert-0 transition-all duration-300 group-hover:scale-110 group-hover:brightness-125 group-hover:drop-shadow-[0_0_15px_rgba(59,130,246,0.5)]" priority />
              </Link>
            </div>
