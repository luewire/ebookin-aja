...
export default function AdminSidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 overflow-y-auto">
      {/* Logo */}
      <div className="p-6 border-b border-slate-200 dark:border-slate-800">
        <Link href="/admin" className="flex items-center gap-3">
          ...
          <span className="font-bold text-xl text-slate-900 dark:text-white">Ebookin</span>
        </Link>
      </div>
