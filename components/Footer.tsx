        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 py-6">
          ...
          <Link href="/" className="flex items-center group">
            <Image 
              ...
              width={48} 
              height={48} 
              className="h-12 w-12 invert dark:invert-0 transition-all duration-300 group-hover:scale-110 group-hover:brightness-125 group-hover:drop-shadow-[0_0_15px_rgba(59,130,246,0.5)]" 
              priority 
            />
          </Link>
